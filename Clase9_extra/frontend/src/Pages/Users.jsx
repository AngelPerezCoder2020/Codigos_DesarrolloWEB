...
export const Users = () => {
  ...
  return (
    <>
      ...
      <button onClick={newUserClick} className='w3-button w3-yellow'>GUARDAR NUEVO USUARIO</button>
      <h1 className='w3-blue'>Usuarios</h1>
      <table className="w3-table w3-striped w3-bordered w3-border w3-gray">
        <thead>
          <tr>
            <th>Id</th>
            <th>Email</th>
